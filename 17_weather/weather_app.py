...
class Weather(HorizontalGroup):
   ...
   def update_weather(self):
      ...
      # "precipitation,rain,weather_code&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=America%2FChicago"
      # "&temperature_unit")
      url = (
      ...
      # url = (f"https://api.open-meteo.com/v1/forecast?latitude={lat}&longitude={lon}&current=temperature_2m,"
      # f"precipitation,rain&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=America%2FChicago")
...
class WeatherApp(App):
   ...
   def compose(self) -> ComposeResult:
      yield Header()
      yield Horizontal(Input(placeholder="Postal Code", id="postal_code"), Button("Add Weather", id="add_weather"), id="add_weather")

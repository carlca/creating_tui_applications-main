...
class MP3Player(App):
   ...
   BINDINGS = [("ctrl+l", "load", "Load Music"), ("escape", "esc", "Exit dialog"), ("p", "previous", "Previous"), ("n", "next", "Next")]
   ...
   def on_file_selection(self, event: DirectoryTree.FileSelected | DirectoryTree.DirectorySelected) -> None:
      """

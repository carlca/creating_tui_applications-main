...
class WidthAndHeightApp(App):
   ...
   def on_mount(self) -> None:
      ...
      self.widget.styles.border = ("double", "red")
      self.widget.border_title = "Alice"
      self.widget.styles.border_title_align = "center"
      self.widget.border_subtitle = "by Lewis Carroll"
      self.widget.styles.border_subtitle_color = "blue"

...
class EditScreen(ModalScreen):
   def __init__(self, path: str, name: str | None = None, id: str | None = None, classes: str | None = None) -> None:
...
class WarningScreen(ModalScreen):
   ...
   def __init__(self, warning_message: str, name: str | None = None, id: str | None = None, classes: str | None = None) -> None:
      super().__init__(name, id, classes)
